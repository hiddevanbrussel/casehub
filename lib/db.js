...
function audit(actor, action, entity, entityId, detail, payload) {
  db.get("audit")
    .unshift({
      id: id(),
      at: nowIso(),
...
const store = {
  ...
  log(actor, action, entity, entityId, detail, payload) {
    audit(actor, action, entity, entityId, detail, payload);
  },
  recipes() {
